...
if __name__ == '__main__':
    for mkt,idx in itertools.product(['es-AR','en-AU','de-AT','nl-BE','fr-BE','pt-BR',
                                                'en-CA','fr-CA','fr-FR','de-DE','zh-HK','en-IN',
                                                'en-ID','it-it','ja-JP','ko-KR','en-MY','es-MX',
                                                'nl-NL','nb-NO','zh-CN','pl-PL','ru-RU','ar-SA',
                                                'en-ZA','en-ES','sv-SE','fr-CH','de-CH','zh-TW',
                                                'tr-TR','en-GB','en-US','es-US'],range(10)):
        print(idx,mkt)
        url = 'http://www.bing.com/HPImageArchive.aspx?format=xml&idx='+str(idx)+'&n=1'+'&mkt='+mkt
        dostuff(url)
